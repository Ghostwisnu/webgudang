              ...
              <div class="box-body">
                <div class="form-group">
                  <?php foreach($data_barang_update as $d){ ?>
                    <input type="hidden" name="id_cons" value="<?=$d->id_cons?>">
                  ...
                  <select class="form-control" name="artcolor_name" style="width:110%;margin-right: 18px;gap: 10px" required>
                    <option value="<?=$d->artcolor_name?>" selected="<?=$d->artcolor_name?>"><?=$d->artcolor_name?></option>
                  ...
                  <select class="form-control" name="item_name" style="width:110%;margin-right: 18px;gap: 10px" required>
                    <option value="<?=$d->item_name?>" selected="<?=$d->item_name?>"><?=$d->item_name?></option>
                  ...
                  <input type="text" name="cons_rate" style="width:90%;margin-right: 67px;" class="form-control" id="cons_rate" placeholder="Cons" value="<?=$d->cons_rate?>" required>
                </div>       
              </div>
            <?php } ?>
              <!-- /.box-body -->
