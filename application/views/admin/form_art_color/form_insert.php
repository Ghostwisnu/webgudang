      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            ...
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('admin/proses_artcolor_masuk_insert')?>" role="form" method="post">
            ...
            <div class="box-body">
                <div class="form-group" style="display:inline-block;gap: 10px;">
                  <label for="art_name" style="width:87%;margin-left: 0px; gap: 10px;">Nama Art</label>
                  <select class="form-control" name="art_name" style="width:110%;margin-right: 18px;gap: 10px" required>
                    <option value="" selected="">-- Pilih --</option>
                    <?php foreach($list_art as $p){ ?>
                    <option value="<?=$p->art_name?>"><?=$p->art_name?></option>
                    <?php } ?>
                  </select>
                  <label for="color_name" style="width:87%;margin-left: 0px; gap: 10px;">Nama Color</label>
                  <select class="form-control" name="color_name" style="width:110%;margin-right: 18px;gap: 10px" required>
                    <option value="" selected="">-- Pilih --</option>
