...
<head>
  ...
  <title>Smart Warehouse | Data Barang Masuk</title>
          ...
          <div class="box box-primary" style="width:94%;">
            ...
            <?php } ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="lokasi" style="margin-left:220px;display:inline;">Dari Dept</label>
                  <input type="text" name="lokasi" style="margin-left:100px;width:20%;display:inline;" class="form-control" readonly="readonly" value="<?=$d->lokasi?>">
                </div>
                <div class="form-group">
                  <label for="dept_tujuan" style="margin-left:220px;display:inline;">Tujuan Dept</label>
                  <select class="form-control" name="dept_tujuan" style="margin-left:85px;width:20%;display:inline;" required>
                    <option value="">-- Send TO --</option>
                    <option value="Cutting/Setting">Cutting/Setting</option>
                    <option value="Sewing">Sewing</option>
                    <option value="SemiWarehouse">Semi Warehouse</option>
                    <option value="Lasting">Lasting</option>
                    <option value="Finishing">Finishing</option>
                  </select>
                </div>
                <div class="form-group" style="margin-bottom:40px;">
                  <label for="jenis_item" style="margin-left:215px;display:inline;">Jenis Item</label>
                  <input type="text" name="jenis_item" style="margin-left:100px;width:20%;display:inline;" class="form-control" readonly="readonly" value="<?=$d->jenis_item?>">
                </div>
                <div class="form-group" style="display:inline-block;">
                  <label for="brand" style="width:87%;margin-left: 12px;">Brand</label>
                  <input type="text" name="brand" readonly="readonly" style="width: 85%;margin-right: 0px;margin-left: 11px;" class="form-control" id="brand" value="<?=$d->brand?>">
                </div>
                <div class="form-group" style="display:inline-block;">
                  <label for="po_number" style="width:87%;margin-left: 0px;">Po Number</label>
                  <input type="text" name="po_number" readonly="readonly" style="width: 90%;margin-right: 0px;margin-left: 0px;" class="form-control" id="po_number" value="<?=$d->po_number?>">
                </div>
                <div class="form-group" style="display:inline-block;">
                  <label for="art" style="width:87%;margin-left: 0px;">Art</label>
                  <input type="text" name="art" readonly="readonly" style="width: 90%;margin-right: 0px;margin-left: 0px;" class="form-control" id="art" value="<?=$d->art?>">
                </div>
                <div class="form-group" style="display:inline-block;">
                  <label for="color" style="width:87%;margin-left: 0px;">Color</label>
                  <input type="text" name="color" readonly="readonly" style="width: 90%;margin-right: px;margin-left: 0px;" class="form-control" id="color" value="<?=$d->color?>">
                </div>
                <div class="form-group" style="display:inline-block;">
                  <label for="kode_barang" style="width:87%;margin-left: 0px;">Kode Material</label>
                  <input type="text" name="kode_barang" readonly="readonly" style="width: 90%;margin-right: 0px;margin-left: 0px;" class="form-control" id="kode_barang" value="<?=$d->kode_barang?>">
                </div>
                <div class="form-group" style="display:inline-block;">
                  <label for="nama_Barang" style="width:73%; margin-left: 12px;">Nama Barang</label>
                  <input type="text" name="nama_barang" readonly="readonly" style="width:85%; margin-left: 12px; margin-right: px;" class="form-control" id="nama_Barang" value="<?=$d->nama_barang?>">
              </div>
                <div class="form-group" style="display:inline-block;">
                  <label for="satuan" style="width:73%;">Satuan</label>
                  <input type="text" name="satuan" readonly="readonly" style="width:90%;margin-right: px;" class="form-control" id="satuan" value="<?=$d->satuan?>">
              </div>
              <div class="form-group" style="display:inline-block;">
                <label for="jumlah" style="width:73%;margin-left:px;">Jumlah</label>
                <input type="number" name="jumlah" style="width:41%;margin-left:px;margin-right:18px;" class="form-control" id="jumlah" max="<?=$d->jumlah?>" value="<?=$d->jumlah?>">
            </div>
            <?php } ?>
              <!-- /.box-body -->
