        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i> Update Size</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('admin/proses_size_update')?>" role="form" method="post">
            ...
            <?php } ?>
              ...
              <div class="box-body">
                <div class="form-group">
                  <?php foreach($data_size as $d){ ?>
                    <div class="box-body">
                      <div class="form-group" style="display:inline-block;">
                        <input type="hidden" name="id_unit" value="<?=$d->id_size?>">
                        <label for="size_name" style="width:87%;margin-left: 12px;">Nama Size</label>
                        <input type="text" required name="size_name" style="width: 90%;margin-right: 67px;margin-left: 11px;" class="form-control" id="size_name" placeholder="Nama Size" value="<?=$d->size_name?>">
                      </div>
                    <div class="form-group" style="display:inline-block;">
                    ...
                    <div class="box-footer" style="width:93%;">
                      ...
                      <a type="button" class="btn btn-info" style="width:13%;margin-right:29%" href="<?=base_url('admin/tabel_size')?>" name="btn_listsatuan"><i class="fa fa-table" aria-hidden="true"></i> Lihat Satuan</a>
